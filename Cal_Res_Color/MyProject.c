#define BUTOND Button(&GPIOA_IDR, 0, 100, 1)
#define BUTONB Button(&GPIOA_IDR, 1, 100, 1)
#define BUTONC Button(&GPIOA_IDR, 2, 100, 1)
#define BUTONA Button(&GPIOA_IDR, 3, 100, 1)
...
void main() {
     GPIO_Digital_Input(&GPIOA_IDR, _GPIO_PINMASK_ALL);                                       //Buton
     GPIO_Digital_Output(&GPIOD_ODR, _GPIO_PINMASK_1 | _GPIO_PINMASK_2 | _GPIO_PINMASK_3);    //LED
     GPIO_Digital_Output(&GPIOE_ODR, _GPIO_PINMASK_9);                                        //LCD
     GPIOE_ODR.B9=0;
